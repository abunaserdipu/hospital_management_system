    ...
    <div class="row">
            ...
            <div class="col-md-9 mt-3">
                <table class="table table-striped table-hover">
                    ...
                    <?php
                    $s_id = $_SESSION['id'];
                        $sql = "SELECT patient_id,patient_name,patient_age,patient_disease FROM appointments WHERE doctor_id='$s_id' AND treatment=''";
                        $result = $db->query($sql);
                        while($data = $result->fetch_assoc()){
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="prescription.php?a_id=<?= $s_id?>&p_id=<?= $data['patient_id']?>"><i class="fa-solid fa-clipboard-check"></i></a>
                                </td>
                            </tr>
                       <?php }
            ?>
